...
import { genChildBoard, heurCal, gameSolve } from "../solver/Solver";
import PriorityQueue from "../solver/PriorityQueue";
import {Guider, getTo} from '../solver/Guider'
...
export default function Board() {
  ...
  return (
    <div className="container">
      <div className="board">
        <div className="piece" onClick={() => {handler(0); userPlay(0)}}>
          {
            midBub == 0 && 
        ...
        <div className="piece" onClick={() => {handler(1); userPlay(1)}}>
          {
            midBub == 1 && 
            <div className="piece-child piece-circle"></div>
          }
        ...
        <div className="piece" onClick={() => {handler(2); userPlay(2)}}>
          {
            midBub == 2 && 
            <div className="piece-child piece-circle"></div>
          }
        ...
        <div className="piece" onClick={() => {handler(3); userPlay(3)}}>
          {
            midBub == 3 && 
            <div className="piece-child piece-circle"></div>
          }
        ...
        <div className="piece" onClick={() => {handler(4); userPlay(4)}}>
          {
            midBub == 4 && 
            <div className="piece-child piece-circle"></div>
          }
        ...
        <div className="piece" onClick={() => {handler(5); userPlay(5)}}>
          {
            midBub == 5 && 
            <div className="piece-child piece-circle"></div>
          }
        ...
        <div className="piece" onClick={() => {handler(6); userPlay(6)}}>
          {
            midBub == 6 && 
            <div className="piece-child piece-circle"></div>
          }
        ...
        <div className="piece" onClick={() => {handler(7); userPlay(7)}}>
          {
            midBub == 7 && 
            <div className="piece-child piece-circle"></div>
          }
      ...
      <div className="board-setting">
          <Row>
            ...
            <Col className="st-col st-c2" xs={3}>
              ...
              <ul>
                <li>Click the button below↓ to generate a solution for the gameboard above. </li>
              ...
              {
                havSol === 0 ? <SolveUnDone /> : havSol === 1 ? <SolveDone /> : null
              }
            ...
            <Col className="st-col st-c3" xs={3}>
              ...
              <ul>
                <li>Click the button below↓ to get a step-by-step guide of the solution.</li>
                <li>If you miss a step, the guide will be cancelled immediately :((</li>
